...
const C = { bg:'#FAF9F5', bgCard:'#FFFFFF', bgElevated:'#F0EEE6', border:'#DEDBD2', borderSubtle:'#ECE9E0', text:'#1F1E1C', sub:'#5C5A52', muted:'#8C8980', dim:'#C2BFB5', accent:'#1F1E1C', accentBorder:'rgba(204,120,92,0.20)' }
        ...
        <div style={{ background:C.bgCard, border:`1px solid ${C.border}`, borderRadius:12, overflow:'hidden' }}>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(7,1fr)' }}>
            ...
            {days.map((d, i) => {
              ...
              return (
                <div key={i} style={{ minHeight:96, padding:'8px', borderRight:(i % 7 !== 6) ? `1px solid ${C.borderSubtle}` : 'none', borderBottom: i < 21 ? `1px solid ${C.borderSubtle}` : 'none', background: isToday ? 'rgba(204,120,92,0.04)' : 'transparent' }}>
